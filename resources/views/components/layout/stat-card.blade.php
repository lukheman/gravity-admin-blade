...
@php
    $colors = [
        'primary' => ['var(--bs-primary)', 'rgba(99, 102, 241, 0.1)'],
        'secondary' => ['var(--bs-secondary)', 'rgba(14, 165, 233, 0.1)'],
        'success' => ['var(--bs-success)', 'rgba(16, 185, 129, 0.1)'],
        'warning' => ['var(--bs-warning)', 'rgba(245, 158, 11, 0.1)'],
        'danger' => ['var(--bs-danger)', 'rgba(239, 68, 68, 0.1)'],
    ];
    $color = $colors[$variant][0] ?? $colors['primary'][0];
    $bgColor = $colors[$variant][1] ?? $colors['primary'][1];
    $trendColor = $trendDirection === 'up' ? 'var(--bs-success)' : 'var(--bs-danger)';
