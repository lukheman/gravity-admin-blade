...
@php
    $variants = [
        'success' => ['rgba(16, 185, 129, 0.1)', 'var(--bs-success)', 'fas fa-check-circle'],
        'danger' => ['rgba(239, 68, 68, 0.1)', 'var(--bs-danger)', 'fas fa-exclamation-triangle'],
        'warning' => ['rgba(245, 158, 11, 0.1)', 'var(--bs-warning)', 'fas fa-exclamation-circle'],
        'info' => ['rgba(14, 165, 233, 0.1)', 'var(--bs-secondary)', 'fas fa-info-circle'],
    ];
